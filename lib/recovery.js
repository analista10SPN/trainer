 ...
 *
 * `Number(null)`, `Number('')` and `Number([])` are all 0, so a missing sample
 * coerces into a measured zero and drags an average down. Only a real number,
 * or a string holding one, counts.
 */
