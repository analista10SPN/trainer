...
export const SCHEMES = {
  ...
  single: {
    id: 'single',
    name: 'One working set',
    warmups: [{ pct: 0.5, reps: '8-10' }],
    working: [{ pct: 1.0, repMin: 10, repMax: 20, note: 'One set — to failure' }],
  },
  'flat-4': {
    id: 'flat-4',
    name: 'Four straight sets — same weight, reps fall',
    warmups: [{ pct: 0.5, reps: '8-10' }],
    working: Array.from({ length: 4 }, () => ({
      pct: 1.0,
      repMin: 12,
      repMax: 20,
